          ...
          <img src={arr} alt="arr" srcset="" className='h-[24px] w-[24px] mt-1 mr-[8px]' /></Link>
           ...
           <img src={both} alt="" srcset="" className='ml-[338px] mt-[30px]' />
             ...
             <div className='flex flex-row h-[36px] ml-[34px] -mt-8 mb-[20px]' >
              ...
              <button onClick={openPopup} className='ml-[53px] h-[36px] w-[173px] bg-[#E40443] text-[13px] font-[600] font-Montserrat text-white rounded-lg items-center justify-center px-[24px] '>Sample collected</button>
