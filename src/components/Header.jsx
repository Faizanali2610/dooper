  ...
  return (
    <>
        ...
        <div className='font-Montserrat flex flex-row font-[700] text-[22px] h-[32px] w-[1077px] pb-[8px]'>
          ...
          <li
            className={`px-4 mt-4 cursor-pointer ${selectedItem === 'Basic Details' ? ' border-b pb-[8px] text-[#E40443] border-[#E40443]' : ''}`}
            onClick={() => handleItemClick('Basic Details')}
          >
           <Link to='/editprofile'>Basic Details</Link> 
          </li>
          <li
            className={`px-4  cursor-pointer ${selectedItem === 'My Association' ? 'border-b pb-[8px] text-[#E40443] border-[#E40443]' : ''}`}
            onClick={() => handleItemClick('My Association')}
        
          >
            <Link to="/association">My Association</Link>
          </li>
          <li
            className={`px-4  cursor-pointer ${selectedItem === 'Documents' ? 'border-b pb-[8px] text-[#E40443] border-[#E40443]' : ''}`}
        ...
        <Link to="/document">Documents</Link>
          ...
          <li
            className={`px-4  cursor-pointer ${selectedItem === 'Bank Info' ? 'border-b pb-[8px] text-[#E40443] border-[#E40443]' : ''}`}
