          ...
          <img src={arr} alt="arr" srcset="" className='h-[24px] w-[24px] mt-1 mr-[8px]' /></Link>
           ...
           <img src={both} alt="" srcset="" className='ml-[338px] mt-[30px]' />
             ...
             <div className='flex flex-row h-[36px] ml-[34px] -mt-8  mb-[32px] ' >
              ...
              <img src={no} alt="no" srcset="" className='' />
              <img src={line} alt="line" srcset="" className=' absolute -mt-[70px] h-[108px] ml-[15px] ' />
              <img src={lineWhite} alt="line" srcset="" className=' absolute mt-[69px] h-[39px] ml-[15px] ' />
             ...
             <div className='flex flex-row h-[36px] ml-[34px] -mt-8' >
              ...
              <Link to="/addreportcard" className='inline-block h-[36px] w-auto bg-[#E40443] text-[13px] font-[600] font-Montserrat text-white rounded-lg items-center justify-center px-[24px] mt-[32px] pt-2'>End Service</Link>
