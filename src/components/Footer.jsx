...
const Footer = () => {
  return (
    <div className='h-[390px] px-[120px] bg-[#B60336] '>
     ...
     <div className='h-[184px] w-[278px] '>
      <img src={dooper} alt="dooper" className='' />
        ...
        <h2 className='font-Montserrat font-[500] text-[16px] leading-[16.24px] -ml-[46px] mt-[22px] text-white'>+1 23 456 7980</h2>
        </div>
        ...
        <div className='font-Montserrat font-[600] text-[18px] text-white ml-[310px] h-[248px] w-[200.5px]  -mt-[183px] pt-[24px]'>
          <h1>Quick Links</h1>
        ...
        <div className='font-Montserrat font-[600] text-[18px] text-white ml-[540px] h-[248px] w-[200.5px]  -mt-[248px] pt-[24px]'>
          <h2>Other</h2>
        <ul className='text-white text-[16px] font-medium list-disc space-y-[14px] h-[170px] pl-6'>
        ...
        <div className='font-Montserrat font-[600] text-[18px] text-white ml-[770px] h-[248px] w-[200.5px]  -mt-[248px] pt-[24px]'>
          <h3>Links</h3>
        ...
        <div className='font-Montserrat font-[600] text-[18px] text-white ml-[1000px] h-[248px] w-[200.5px]  -mt-[248px] pt-[24px]'>
        ...
        <hr className='w-[1440px] -ml-[122px] mt-[40px]' /> 
