...
const EarningCard = () => {
  return (
    <div className='p-[32px]  bg-white w-[484px] rounded-lg '>
      ...
      <h1 className=' font-Montserrat text-[14px] font-medium text-black'>#12345</h1>
         <h2 className=' font-Montserrat text-[12px] font-normal text-[#38404A] mt-[8px]'>16,June 2023</h2>
         <div className='absolute flex px-[16px] py-[8px] rounded-[40px] bg-[#E5FFF2] text-[#41B079] font-Montserrat text-[12px] font-medium
      ...
      <div className='relative p-[20px] rounded-lg border border-[#E3E6E8] mt-[24px]'>  
        ...
        <img src={doubleleft} alt="" className='ml-[43px]' />
